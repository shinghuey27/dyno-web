    ...
    <TableContainer component={Paper} style={{ padding: 20, width: "auto" }}>
      ...
      <Table sx={{}} aria-label="simple table">
        <TableHead style={{ backgroundColor: "#FFDD00" }}>
          <TableRow>
            <TableCell style={{ borderBottom: 0 }} width={"50%"}>
              DESCRIPTION
            </TableCell>
            <TableCell style={{ borderBottom: 0 }} width={"15%"}>
              DATE
            </TableCell>
          ...
          {rows.map((row, index) => (
            ...
            >
              ...
              >
                ...
                >
                  {row?.account.slice(0, 2)}
                </div>
                <span style={{ alignSelf: "center", marginLeft: 13 }}>
                  {row?.account}
                </span>
              </TableCell>
              <TableCell component="th" style={cellTableStyle} scope="row">
                {row?.date}
              </TableCell>

              <TableCell style={cellTableStyle} align="center">
                {renderAmount(parseFloat(row?.amount))}
              </TableCell>
              <TableCell style={cellTableStyle} align="center">
