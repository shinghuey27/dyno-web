...
const rows = [
  createData("1", "Tenaga Nasional Bhd", "Payment", "23 Jan 2020", "-100.00"),
  createData("2", "Eunice Khoo", "Transfer", "23 Jan 2020", "-2,000.00"),
  createData("3", "Indah Water", "JomPAY", "23 Jan 2020", "-20,000.00")
];
...
export default function MUITable4() {
